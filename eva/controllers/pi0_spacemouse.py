...
'''
Pi0 - SpaceMouse Mixed controller for EVA framework
Author: Jie Wang
Version: 
...
'''
@dataclass
class MixedControllerConfig:
    # PI0 config
    init_instruction: str = "find the target object and pick it up"
...
class MixedController:
    def __init__(self, config: MixedControllerConfig = MixedControllerConfig(), on_switch_callback=None):
        """Initialize both controllers and set up switching logic"""
        print("Initializing Mixed Controller (PI0 + SpaceMouse)")
