...
class ServerInterface:
    ...
    def create_action_dict(self, command, action_space="cartesian_velocity", gripper_action_space="velocity", robot_state=None):
        # Note: robot_state is handled server-side if None
        action_dict = self.server.create_action_dict(command.tolist(), action_space, gripper_action_space, robot_state)
        return action_dict
