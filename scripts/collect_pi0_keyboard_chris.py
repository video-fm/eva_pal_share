# Added by Chris on May 27, 2025 to try to toggle between Pi0 and keyboard teleop.
# Just changing details from collect_pi_spacemouse.py
#!/usr/bin/env python3
...
def main():
    ...
    runner = load_runner(manager=False, controller='keyboard_pi0', record_depth=False, record_pcd=False, post_process=True)
    ...
    print("  =: switch between PI0 and Keyboard")
